...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
       <div class="site-blocks-cover inner-page overlay xyz" style="background-image: url(images/theme.jpg);" data-aos="fade" data-stellar-background-ratio="0.5" style="width: 100%;">
         <div class="row align-items-center justify-content-center">
            <div class="col-md-6 text-center" data-aos="fade">
              <h1 class="font-secondary  font-weight-bold text-uppercase">About us</h1>
               <div><a href="/welcome">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">About us</span></div>
            </div>
          </div>
      </div>
   </div>
      ...
      <div class="container"> 
      <section class="section-gap" id="service">
            <div class="container">
        ...
        <section class="service-area section-gap" id="service">
            <div class="container">
              <div class="site-half block">
                <div class="img-bg-1 right" style="background-image: url('images/2001.jpeg');" data-aos="fade"></div>
                <div class="container">
                  <div class="row no-gutters align-items-stretch">
                    <div class="col-lg-5 mr-lg-auto py-5" >
                      <span class="caption d-block mb-2 font-secondary font-weight-bold"></span>
                      <h2 class="site-section-heading text-uppercase font-secondary mb-5">Our Mission</h2>
                      <p style="text-align: justify;"> Our misson is winning the confidence of all our customers. Our specialisation is to manufacture and supply as per customer needs and specifications, Simultaneously meeting all international quality standards.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="container">
                    <div class="row no-gutters align-items-stretch">
                      <div class="col-lg-5 ml-lg-auto py-5">
                        <span class="caption d-block mb-2 font-secondary font-weight-bold"> </span>
                        <h2 class="site-section-heading text-uppercase font-secondary mb-5">Company History</h2>
                        <p style="text-align: justify;"> The company began its operations in 1964 by Mr. Baldev chander arora (Founder) . Since then we are supplying our customers to there satisfaction.</p>
                         <p><a href="/basic_profile" class="btn btn-primary text-white px-4">Read More</a></p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="container-fluid">
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col-lg-3 no-padding feat-txt">
                ...
                <h1>What we do</h1>
                <p >
                  We are manufactures,traders,suppliers and exporters of shoe laces,tapes,cords and other garment accessories.
                </p>
              </div>
            </div>
          </div>  
