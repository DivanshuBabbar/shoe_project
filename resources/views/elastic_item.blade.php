...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
  ...
  <div class="site-wrap">
                     ...
                     <li class="has-children ">
                      <a href="/">Others</a>
                       <ul class="dropdown arrow-top">
                        ...
                        <li class="active"><a href="elastic_item">Elastic item</a></li>
                      </ul>
                    </li>
       ...
       <div class="site-blocks-cover inner-page overlay xyz" style="background-image: url(images/theme.jpg);" data-aos="fade" data-stellar-background-ratio="0.5" style="width: 100%;">
         <div class="row align-items-center justify-content-center">
            <div class="col-md-6 text-center" data-aos="fade">
              <h1 class="font-secondary  font-weight-bold text-uppercase">Elastic item</h1>
               <div><a href="/welcome">Home</a> <span class="mx-2 text-white">&bullet;</span> <span class="text-white">Elastic item</span></div>
            </div>
          </div>
      </div>
   </div>
    ...
    <div class="site-section">
      ...
      <p>It is 6 mm kaj elastic used in medical equipment. Note: Width and Quality can be varried as per customer requirements.</p>
      ...
      <!-- <span class="d-block mb-3">By James — Jan. 20, 2019</span> -->
      <p>It is 8 mm elastic tape used in garments industries,Footwear industries , Medical industries and other industries.
        Note: Quality and width can be altered as per customer specifications.</p>
      <!-- <p><a href="#">Read More</a></p> -->
      </div>
      </div>
      </div>
