     ...
     <!--  <div class="container">
        <div class="row mb-5">
          <div class="col-md-12 text-center" data-aos="fade"> 
            ...
            <h2 class="site-section-heading text-uppercase text-center font-secondary">Love Us</h2>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="site-section-heading mb-3 font-secondary text-uppercase">content</h2>
