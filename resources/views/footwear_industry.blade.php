              ...
              <div class="details_title">
                ...
                <div class="col-xl-12">
                  <div class="details_main_wrap">
                   <h1 style="text-align: center; color: #71bc42 !important;">Footwear Accessories </h1>
                   <br>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="site-section-heading text-uppercase text-center font-secondary">Our Products</h2>
             <span class="caption d-block mb-2 font-secondary font-weight-bold">Footwear Accessories</span>
          </div>
        </div>
     <div class="container">
